...
<div style="margin-top:-50px; margin-left:15px">Rabu, 10/05/2018 <button class="btn" style="background-color:black; color:white">10:15</button></div>
				...
				<div class="row">
						<div class="col-md-3">
							<nav class="navbar navbar-danger" >
								<center>
									<div class="dropdown">
										<a href="/grafik" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" style="width:98%;" >
											Dashboard Grafik &nbsp
											<i class="material-icons">arrow_drop_down</i>
										</a>
										<ul class="dropdown-menu" style="width:100%; text-align:center; margin-top:15px">
											<li><a href=""  style="width:98%">Dashboard Tabel </a></li>
