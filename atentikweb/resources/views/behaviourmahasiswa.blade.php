				...
				<div class="row">
						<div class="col-md-3">
							<nav class="navbar navbar-danger" >
								<center>
									<div class="dropdown">
										<a href="/behaviourmahasiswa" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" style="width:98%;" >
											Behaviour Mahasiswa &nbsp
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="title">Perbandingan tempat yang paling lama mahasiswa kunjungi </h4>
