				...
				<div class="row">
						<div class="col-md-3">
							<nav class="navbar navbar-danger" >
								<center>
									<div class="dropdown">
										<a href="/behaviourdosen" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" style="width:98%;" >
											Behaviour Dosen &nbsp
											<i class="material-icons">arrow_drop_down</i>
										</a>
										<ul class="dropdown-menu" style="width:100%; text-align:center; margin-top:15px">
											<li><a href="/tracking"  style="width:98%">Realtime Tracking</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="title">Perbandingan tempat yang paling sering dosen kunjungi</h4>
                                    <p class="category">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="title">Perbandingan tempat yang paling lama dosen kunjungi </h4>
